...
APP.get("/teste-de-parametro/:nome", function(req, res) {
    res.send("Ola " + req.params.nome);
    // Colocando os dois pontos na url você define um parâmetro que pode ser acessado por req.params
    // Acesse a seguinte url para testar: http://localhost:8081/teste-de-parametro/testando
});
